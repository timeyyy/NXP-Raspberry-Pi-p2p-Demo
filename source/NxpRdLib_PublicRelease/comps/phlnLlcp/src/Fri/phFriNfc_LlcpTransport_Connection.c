...
#define  PRINT_TRACE          0     // this is defined just for debugging reason
...
static NFCSTATUS phFriNfc_Llcp_GetSocket_Params(
   ...
   if(socketFound)
      ...
      do
         ...
         if(nr_val == psLocalLlcpSocket->socket_VS)
            {
            // printf("nr value is %d, vs value is %d \n", nr_val, psLocalLlcpSocket->socket_VS);
            break;
            }
         ...
         if(nr_val == psLocalLlcpSocket->socket_VSA)
            {
            // printf("nr value is %d, vsa value is %d \n", nr_val, psLocalLlcpSocket->socket_VSA);
            /* FRMR 0x02 */
            RFlag = TRUE;
            break;
            }
   ...
   switch(ptype)
      ...
      case PHFRINFC_LLCP_PTYPE_CONNECT:
         ...
         Handle_ConnectionFrame(psTransport,
               ...
               dsap,
               ssap);
         if (PRINT_TRACE) printf("LLCP in: CONNECT (04)\n");
      ...
      case PHFRINFC_LLCP_PTYPE_DISC:
         ...
         Handle_DisconnectFrame(psTransport,
               dsap,
               ssap);
         if (PRINT_TRACE) printf("LLCP in: DISCONNECT (05)\n");
         }break;
      ...
      case PHFRINFC_LLCP_PTYPE_CC:
         ...
         Handle_ConnectionCompleteFrame(psTransport,
               ...
               dsap,
               ssap);
         if (PRINT_TRACE) printf("LLCP in: CC (06)\n");
         }break;
      ...
      case PHFRINFC_LLCP_PTYPE_FRMR:
         ...
         Handle_FrameReject_Frame(psTransport,
               dsap,
               ssap);
         if (PRINT_TRACE) printf("LLCP in: FRMR (08)\n");
         }break;
      ...
      case PHFRINFC_LLCP_PTYPE_I:
         ...
         Handle_Receive_IFrame(psTransport,
               ...
               dsap,
               ssap);
         if (PRINT_TRACE) printf("LLCP in: I (12)\n");
         }break;
      ...
      case PHFRINFC_LLCP_PTYPE_RR:
         ...
         Handle_ReceiveReady_Frame(psTransport,
               ...
               dsap,
               ssap);
         if (PRINT_TRACE) printf("LLCP in: RR (13)\n");
         }break;
      ...
      case PHFRINFC_LLCP_PTYPE_RNR:
         ...
         Handle_ReceiveNotReady_Frame(psTransport,
               ...
               dsap,
               ssap);
         if (PRINT_TRACE) printf("LLCP in: RNR (14)\n");
         }break;
      ...
      case PHFRINFC_LLCP_PTYPE_RESERVED3:
         ...
         phFriNfc_LlcpTransport_SendFrameReject( psTransport,
               ...
               0, 0, 0, 0);
         if (PRINT_TRACE) printf("LLCP in: default\n");
         }break;
         //      default:
 ...
 * \retval NFCSTATUS_FAILED                   Operation failed.
 */
NFCSTATUS phLibNfc_LlcpTransport_ConnectionOriented_Disconnect(
...
static void phFriNfc_LlcpTransport_ConnectionOriented_DisconnectClose_CB(
      void*        pContext,
      NFCSTATUS    status)
   {
...
NFCSTATUS phFriNfc_LlcpTransport_ConnectionOriented_Close(phFriNfc_LlcpTransport_Socket_t*   pLlcpSocket)
   ...
   if(pLlcpSocket->eSocket_State == phFriNfc_LlcpTransportSocket_eSocketConnected)
      {
      status = phLibNfc_LlcpTransport_ConnectionOriented_Disconnect(
            pLlcpSocket,
