 ...
 */
/*@{*/
#define PHNFCTYPES_FILEREVISION "$Revision: 1.2 $" /**< \ingroup grp_file_attributes */
#define PHNFCTYPES_FILEALIASES  "$Aliases:  $"     /**< \ingroup grp_file_attributes */
/*@}*/
