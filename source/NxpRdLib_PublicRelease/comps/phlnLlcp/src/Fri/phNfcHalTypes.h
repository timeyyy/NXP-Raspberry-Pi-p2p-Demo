...
/*@{*/
#define PHNFCHALTYPES_FILEREVISION "$Revision: 1.2 $" /**< \ingroup grp_file_attributes */
#define PHNFCHALTYPES_FILEALIASES  "$Aliases:  $"     /**< \ingroup grp_file_attributes */
/*@}*/
