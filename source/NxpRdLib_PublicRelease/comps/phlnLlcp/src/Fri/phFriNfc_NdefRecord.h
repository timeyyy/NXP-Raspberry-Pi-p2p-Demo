 ...
 */
/*@{*/
#define PHFRINFC_NDEFRECORD_FILEREVISION "$Revision: 1.3 $"  /**< \ingroup grp_file_attributes */
#define PHFRINFC_NDEFRECORD_FILEALIASES  "$Aliases:  $"       /**< \ingroup grp_file_attributes */
/*@}*/
