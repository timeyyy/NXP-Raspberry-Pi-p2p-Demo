...
typedef phFriNfc_Llcp_Check_CB_t phlnLlcp_Check_CB_t;

typedef void (*phFriNfc_Llcp_LinkStatus_CB_t) (
   void                             *pContext,
   phFriNfc_Llcp_eLinkStatus_t      eLinkStatus
);
typedef phFriNfc_Llcp_LinkStatus_CB_t phlnLlcp_LinkStatus_CB_t;

typedef void (*phFriNfc_Llcp_Send_CB_t) (
   void                             *pContext,
   NFCSTATUS                        status
);
typedef phFriNfc_Llcp_Send_CB_t phlnLlcp_Send_CB_t;
...
typedef phFriNfc_Llcp_Recv_CB_t phlnLlcp_Recv_CB_t;
...
} phFriNfc_Llcp_sPacketHeader_t, phlnLlcp_sPacketHeader_t;
...
} phFriNfc_Llcp_sPacketSequence_t, phlnLlcp_sPacketSequence_t;
