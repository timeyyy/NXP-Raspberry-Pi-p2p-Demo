...
typedef void (*pphFriNfc_LlcpTransportSocketErrCb_t) ( void*      pContext,
                                                       uint8_t    nErrCode);
typedef pphFriNfc_LlcpTransportSocketErrCb_t phlnLlcp_TransportSocketErrCb_t;
...
typedef pphFriNfc_LlcpTransportSocketListenCb_t phlnLlcp_TransportSocketListenCb_t;
...
typedef void (*pphFriNfc_LlcpTransportSocketConnectCb_t)  ( void*        pContext,
                                                            uint8_t      nErrCode,
                                                            NFCSTATUS    status);
typedef pphFriNfc_LlcpTransportSocketConnectCb_t phlnLlcp_TransportSocketConnectCb_t;
...
typedef void (*pphFriNfc_LlcpTransportSocketAcceptCb_t) (void*        pContext,
                                                         NFCSTATUS    status);
typedef pphFriNfc_LlcpTransportSocketAcceptCb_t phlnLlcp_TransportSocketAcceptCb_t;
...
typedef void (*pphFriNfc_LlcpTransportSocketRejectCb_t) (void*        pContext,
                                                         NFCSTATUS    status);
typedef pphFriNfc_LlcpTransportSocketRejectCb_t phlnLlcp_TransportSocketRejectCb_t;
...
typedef void (*pphFriNfc_LlcpTransportSocketRecvCb_t) (void*     pContext,
                                                       NFCSTATUS status);
typedef pphFriNfc_LlcpTransportSocketRecvCb_t phlnLlcp_TransportSocketRecvCb_t;
...
typedef void (*pphFriNfc_LlcpTransportSocketRecvFromCb_t) (void*       pContext,
                                                           uint8_t     ssap,
                                                           NFCSTATUS   status);
typedef pphFriNfc_LlcpTransportSocketRecvFromCb_t phlnLlcp_TransportSocketRecvFromCb_t;
...
typedef void (*pphFriNfc_LlcpTransportSocketSendCb_t) (void*        pContext,
                                                       NFCSTATUS    status);
typedef pphFriNfc_LlcpTransportSocketSendCb_t phlnLlcp_TransportSocketSendCb_t;
