...
#ifndef PHOSAL_R_PI_H
#define PHOSAL_R_PI_H

// igor - zmenit popisky ku funckiam
...
phStatus_t phOsal_R_Pi_Timer_Start(
    phOsal_R_Pi_DataParams_t * pDataParams,  /**<[In] pointer to this layer's data structure */
...
phStatus_t phOsal_R_Pi_Timer_Create(
    phOsal_R_Pi_DataParams_t *pDataParams,   /**<[In]  DataParams representing this component */
...
phStatus_t phOsal_R_Pi_Timer_Wait(
    phOsal_R_Pi_DataParams_t * pDataParams,  /**<[In] Data structure representing this component */
...
phStatus_t phOsal_R_Pi_GetMemory(
    phOsal_R_Pi_DataParams_t *pDataParams,   /**< [In] Pointer to this layers parameter structure. */
