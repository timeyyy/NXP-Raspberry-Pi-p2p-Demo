                                   ...
                                   )
{
    ...
    /* __DEBUG will be defined only for joiner boards. These changes are done to support 512 blue board */
#ifdef __DEBUG
    ...
    if (pDataParams->bBalConnectionType == PHHAL_HW_BAL_CONNECTION_SPI)
    {
        ...
        /* These changes are done to support LPC1227 */
#ifdef __DEBUG
