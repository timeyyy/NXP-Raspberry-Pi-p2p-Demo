                                       ...
                                       )
{
    ...
    else if (pDataParams->bBalConnectionType == PHHAL_HW_BAL_CONNECTION_SPI)
    {
        ...
        /* __DEBUG will be defined only for joiner boards. These changes are done to support Rc663 blue board */
#ifdef __DEBUG
        /* JLL 21/10/2011 */
        bNumExpBytes = 2;
#endif /* __DEBUG */
                                   ...
                                   )
{
	...
	case PHHAL_HW_CONFIG_SETMINFDT:
		...
		phhalHw_Rc663_SetMinFDT(pDataParams, wValue);
		break;
